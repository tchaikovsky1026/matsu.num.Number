 ...
 */
@Ignore
final class ModuloLongTesting {

    private ModuloLongTesting() {
    ...
    static abstract class Prod2 {
        ...
        public void test_2値積のモジュロをテスト(Fixture fixture) {
            ...
            try {
                ModuloLong modulus = getModulusLong(m);
        ...
        public void test_2値積のモジュロをテスト_ランダム化(long divisor) {
            ...
            try {
                ModuloLong modulus = getModulusLong(divisor);
         ...
         */
        abstract ModuloLong getModulusLong(long m);
    ...
    static abstract class GcdInverse {
        ...
        @Theory
        public void test_GcdInverseをテスト_ランダム化(long divisor) {
            ...
            try {
                ...
                for (int c = 0; c < ite; c++) {
                    ...
                    long a = ThreadLocalRandom.current().nextLong(divisor * 5);
