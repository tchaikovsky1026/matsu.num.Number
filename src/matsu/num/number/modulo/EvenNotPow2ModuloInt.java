 ...
 * @author Matsuura Y.
 */
final class EvenNotPow2ModuloInt extends SkeletalModuloInt {
     ...
     */
    EvenNotPow2ModuloInt(int pow2Exponent, int innerDivisor) {
        super();
        ...
        this.m = innerDivisor;
        this.modPow2Calculator = new ModuloIntPow2(pow2Exponent);
