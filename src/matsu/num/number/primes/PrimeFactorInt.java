...
public final class PrimeFactorInt implements Comparable<PrimeFactorInt> {
    ...
    public final Optional<PrimeFactorInt> dividedBy(int q) {
        return !this.isPrime() && this.factor2Number.containsKey(Integer.valueOf(q))
     ...
     * 要素を持たないイテレータ.
     */
    private static final class EmptyIterator implements Iterator<PrimeFactorInt> {

        /**
         * このクラスのインスタンスはシングルトン.
         */
        static final Iterator<PrimeFactorInt> INSTANCE = new EmptyIterator();
