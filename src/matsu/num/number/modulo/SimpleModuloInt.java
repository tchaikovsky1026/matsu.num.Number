 ...
 */
@Deprecated
abstract class SimpleModuloInt extends SkeletalModuloInt {
     ...
     */
    static SimpleModuloInt of(int divisor) {
        if (divisor <= 0) {
     ...
     */
    private static final class SmallDivisorImpl extends SimpleModuloInt {
     ...
     */
    private static final class LargeDivisorImpl extends SimpleModuloInt {
