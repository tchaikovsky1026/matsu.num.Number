...
/**
 * 32-bit 整数の 2^32 に対するモジュロ逆元を計算するユーティリティ. <br>
 * 符号有り/無しを問わない.
 * 
 * <p>
 * 機能メモ: <br>
 * m に対し, ym = 1 mod 2^32 とする. <br>
 * このとき, 1 以上 32 以下の d について, ym = 1 mod 2^d である. <br>
...
final class ModPow2InverseUtil {
    ...
    /**
     * {@code int} 型整数について, R = 2^32 を法とした逆元を計算する.
     * 
     * <p>
     * n は奇数でなければならない. <br>
     * ただし, このバリデーションは行われない.
